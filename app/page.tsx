      ...
      <section id="case-studies" className="section-gap-xl bg-[#faf8f5]">
        <div className="container-section px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-3 mb-12">
            <article className="group w-full max-w-[400px] mx-auto md:mx-0 p-6 bg-white border border-[rgba(17,17,17,0.08)] rounded-lg transition-safe hover:-translate-y-2 hover:shadow-lg hover:border-[#0F766E] hover:backdrop-blur-sm">
            ...
            <article className="group w-full max-w-[400px] mx-auto md:mx-0 p-6 bg-white border border-[rgba(17,17,17,0.08)] rounded-lg transition-safe hover:-translate-y-2 hover:shadow-lg hover:border-[#0F766E] hover:backdrop-blur-sm">
              <h3 className="text-xl font-semibold text-[#111111] mb-3">Ustadh Abdulaziz Haqqan</h3>
