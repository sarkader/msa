  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative section-gap-xxl overflow-hidden bg-[#FAFAFA]">
        {/* Premium gradient: dark graphite → warm gray with subtle tint */}
        <div
          className="absolute inset-0 -z-20"
          style={{
            background:
              "linear-gradient(135deg, #2a2a2a 0%, #4a4a4a 25%, #5a5a5a 50%, #6a6a6a 75%, #e8e8e8 100%)",
            filter: "blur(32px)",
            transform: "scale(1.1)",
            opacity: 0.15,
          }}
        ...
        {/* Decorative background image with radial-gradient mask */}
        <div className="absolute inset-0 -z-10 opacity-35" aria-hidden="true">
          <Image
            ...
            style={{
              maskImage:
                "radial-gradient(circle at 60% 40%, rgba(255,255,255,0.8) 0%, transparent 60%)",
              WebkitMaskImage:
                "radial-gradient(circle at 60% 40%, rgba(255,255,255,0.8) 0%, transparent 60%)",
            }}
            priority
        ...
        <div className="container-tight relative z-10 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center text-center">
          ...
          {/* Stats row */}
          <Reveal className="reveal w-full max-w-3xl mx-auto">
      ...
      {/* Process - Zig-zag layout with supporting image */}
      <section className="section-gap-xxl border-y border-[#EDEDED] bg-white">
        <div className="container-tight px-4 sm:px-6 lg:px-8">
          ...
          {/* Supporting image on desktop, stacked on mobile */}
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <div
              className="absolute left-1/2 top-0 bottom-0 w-px bg-[#EDEDED] hidden md:block transform -translate-x-1/2"
              aria-hidden="true"
            />

            <div className="space-y-24">
              {/* Step 1 - Left */}
              <Reveal className="reveal relative flex items-center gap-8 md:flex-row">
                <div className="md:w-1/2 md:pr-12">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-12 h-12 rounded-full bg-[#0A0A0A] flex items-center justify-center text-white font-semibold text-lg border-4 border-white shadow-md">
                      1
                    </div>
