    ...
    <div className="min-h-screen bg-[#FAFAFA]">
      <section className="section-gap-xxl">
        <div className="container-tight px-4 sm:px-6 lg:px-8">
          ...
          {/* Noscript fallback */}
          <noscript>
            <div className="bg-white border border-[#EDEDED] rounded-lg p-8 text-center mb-8">
          ...
          <div className="bg-white border border-[#EDEDED] rounded-lg p-4 md:p-8 overflow-hidden">
